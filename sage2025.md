...
> > > *Variant (**Athletics**{: .heart-color }), Split, Hustle, Commitment, Unwieldy, Situational (Common: **SP**{: .courage-color } can't be used to modify the Technique in any way)*{: .italic .fs-3 }
> > >
> >
> > {: .specie-inner-callout }  
